...
## Этап 9: Обновление и очистка скриптов сборки и конфигурационных файлов

- [x] 9.1 Обновить `run.sh` для использования `npm` и правильного имени пакета.
- [x] 9.2 Обновить `Makefile` для использования `npm` и правильного имени пакета.
- [x] 9.3 Удалить ненужный файл `.gitmodules`.
